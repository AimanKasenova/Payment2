	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:400px">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="payslip" value="1" <?php echo isset($payslip1);?>>  Payslip
  </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name"></label>
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="valid_id" value="1" <?php echo isset($valid_id1);?>> 2 Valid ID 
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name"></label>
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="cert" value="1" <?php echo isset($cert1);?>> Brgy. Certificate 
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name"></label>
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="cedula" value="1" <?php echo isset($cedula1);?>>  Cedula
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name"></label>
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="income" value="1" <?php echo isset($income1);?>>  Proof of Income
          </div>
        </div>        
